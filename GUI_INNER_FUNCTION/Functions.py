...
class GUI_show():
    ...
    def __init__(self,email_lists):
        self.email_lists = email_lists
    ...
    def show(self):
        ...
        def ok_button_2_click(string):
            ...
            if blog_address and ids and pwd:
                ...
                while True:
                    if std_email in self.email_lists:

                        idx = self.email_lists.index(std_email)
                        result_list = self.email_lists[:idx + 1]
